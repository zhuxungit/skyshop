...
<div class="navbar navbar-inverse">
    <div class="navbar-inner">
        ...
        <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">sky商城 - 后台管理</a>
    ...
    <ul id="dashboard-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                ...
                <li><a href="<?php echo Url::to(['category/add']); ?>">添加新分类</a></li>
            </ul>
        </li>
