                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                                ...
                                echo $form->field($model, 'ishot')->radioList([0 => '非热卖', 1 => '热卖'], ['class' => 'span8']);
                                echo $form->field($model, 'issale')->radioList(['非促销', '促销'], ['class' => 'span8']);
                                ...
                                echo $form->field($model, 'istui')->radioList(['非推荐', '推荐'], ['class' => 'span8']);
                                ...
                                <?php
                                    ...
                                    echo $form->field($model, 'pics[]')->fileInput([
                                        'class' => 'product-pics span9',
//                                        'template'=>'<a href="javascript:void(0)" onclick="copyown(this)">[+]</a>{input}'
                                    ]);
                                ?>
                                <?php
                                ...
                                ?>
                                    ...
                                    <a href="<?php echo Url::to(['product/removepic', 'key' => $k, 'productid' => $model->productid]) ?>">删除</a>
                                <?php
                                }
                                ?>
                                <hr>
                                <input type='button' id="addpic"  onclick="add()"  value='增加一个商品图片'>
<!--                            <input type='button' id="addpic"  onclick="rem()"  value='减少一个商品图片'>-->
