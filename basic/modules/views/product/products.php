                    ...
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            <td>
                                ...
                                <a href="<?php echo Url::to(['product/detail','productid'=>$product->productid])?>" class="name"><?php echo $product->title; ?></a>
                            </td>
                            <td>
                            ...
                            <a href="<?php echo Url::to(['product/mod', 'productid' => $product->productid]); ?>">编辑</a>
                            <a href="<?php echo Url::to(['product/on', 'productid' => $product->productid]); ?>">上架</a>
                            <a href="<?php echo Url::to(['product/off', 'productid' => $product->productid]); ?>">下架</a>
                            <a href="<?php echo Url::to(['product/del', 'productid' => $product->productid]); ?>">删除</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        </tbody>
